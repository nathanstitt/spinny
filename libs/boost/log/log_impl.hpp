...
#ifndef JT_BOOST_LOG_LOG_IMPL_HPP
#define JT_BOOST_LOG_LOG_IMPL_HPP
...
// ... make it work for VC6 as well

// logs a message
//typedef boost::function<void (const logging_types::string&,const logging_types::string&)> appender_func;
typedef boost::function2<void, const logging_types::string&,const logging_types::string& > appender_func;
// modifies a message
//typedef boost::function<void (const logging_types::string&,logging_types::string&)> modifier_func;
typedef boost::function2<void, const logging_types::string&, logging_types::string&> modifier_func;

}}

#include <boost/log/detail/log_manager.hpp>
...
#include <boost/log/detail/manipulate_logs.hpp>
